...
public class MyBluetoothDeviceAdapter extends RecyclerView.Adapter<MyBluetoothDeviceAdapter.ViewHolder> {
    ...
    private void initDrawableList() {
        ...
        mDrawableList.add(R.drawable.bluele_dev);
    ...
    public MyBluetoothDeviceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.BLEname=device.getName();
                MainActivity.BLEaddress=device.getAddress();
//                MainActivity.tvdev.setText("dev : "+device.getName()+"|  add : "+device.getAddress());
                MainActivity.tvdev.setText("device : "+device.getName());
