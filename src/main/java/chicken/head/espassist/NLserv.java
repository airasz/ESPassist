...
public class NLserv extends NotificationListenerService {
...
//        String appname=(String) packageManager.getApplicationLabel(packageManager.getApplicationInfo(pn,packageManager.GET_META_DATA));
        ...
        if(title==null)i.putExtra("notification_event",appName+"\n"+text);
        else         i.putExtra("notification_event",appName + "\n"+ title+" : "+text);
//        if(!title.equals("")){
//            if(textlenght>55){
//
//
    ...
    class NLServiceReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.getStringExtra("command").equals("clearall")){
                NLserv.this.cancelAllNotifications();
            }
                ...
                sendBroadcast(i1);
                int i=1;
                for (StatusBarNotification sbn : NLserv.this.getActiveNotifications()) {
